...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-[var(--brand-primary)] hover:brightness-110 text-white shadow-glow focus:ring-[var(--brand-primary)] border border-transparent',
      secondary:
      ...
      danger:
        'bg-red-500 hover:bg-red-600 text-white focus:ring-red-500 border border-transparent',
    };
